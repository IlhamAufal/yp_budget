      ...
      <div class="mb-6">
        ...
        <ul class="flex flex-col gap-1.5">
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-industry text-lg min-w-[24px] text-center <?= url_is('foh*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                FOH
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-building text-lg min-w-[24px] text-center <?= url_is('opex-ga*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Opex GA
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-store text-lg min-w-[24px] text-center <?= url_is('opex-selling*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Opex Selling
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-coins text-lg min-w-[24px] text-center <?= url_is('capex*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Capex
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-chart-line text-lg min-w-[24px] text-center <?= url_is('sales*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Sales
              </span>
              <i
      ...
      <div class="mb-6">
        ...
        <ul class="flex flex-col gap-1.5">
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-folder-plus text-lg min-w-[24px] text-center <?= url_is('mpp*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Man Power Planning
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-database text-lg min-w-[24px] text-center <?= url_is('master*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                Master Data
              </span>
              <i
          ...
          <li>
            ...
            >
              <i class="fa-solid fa-user-shield text-lg min-w-[24px] text-center <?= url_is('sys-admin*') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300' ?>"></i>
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
