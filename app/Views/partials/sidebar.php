...
<aside
  id="app-sidebar"
  class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 dark:border-gray-800 dark:bg-black lg:static"
>
  <div class="sidebar-header flex h-20 items-center justify-center px-4 pt-4 pb-2 transition-all duration-300">
    <a href="<?= base_url('/') ?>" class="flex items-center justify-center w-full">
      <span class="logo logo-full flex items-center justify-center">
