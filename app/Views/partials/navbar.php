  ...
  >
    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        <button
          type="button"
          @click="window.dispatchEvent(new CustomEvent('open-year-modal'))"
          class="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold bg-brand-50 text-brand-600 border border-brand-200/70 hover:bg-brand-100 hover:border-brand-300 dark:bg-brand-500/10 dark:text-brand-400 dark:border-brand-500/20 dark:hover:bg-brand-500/20 transition shadow-xs"
          title="Klik untuk mengganti Tahun Anggaran (Working Year)"
        >
          <i class="fa-solid fa-calendar-days text-sm text-brand-500 dark:text-brand-400"></i>
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= base_url('assets/images/user/user-02.jpg') ?>"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= base_url('assets/images/user/user-03.jpg') ?>"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= base_url('assets/images/user/user-04.jpg') ?>"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= base_url('assets/images/user/user-05.jpg') ?>"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
