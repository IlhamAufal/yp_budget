<header
  class="sticky top-0 z-40 flex w-full border-b border-gray-200/80 bg-white/95 backdrop-blur-md dark:border-gray-800 dark:bg-gray-900/95 transition-colors shadow-xs"
>
  <div
    class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6"
  >
    <div
      class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:w-auto lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800"
    >
      ...
      <a href="<?= base_url('/') ?>" class="lg:hidden">
    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-3">
        <!-- Working Year Switcher Button -->
        <button
          type="button"
          data-action="open-year-modal"
          class="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold bg-[#2F3185]/10 text-[#2F3185] hover:bg-[#2F3185]/15 dark:bg-[#2F3185]/20 dark:text-indigo-300 dark:hover:bg-[#2F3185]/30 transition-all shadow-2xs active:scale-[0.98] cursor-pointer"
          title="Klik untuk mengganti Tahun Anggaran (Working Year)"
        >
          <i class="fa-solid fa-calendar-days text-sm text-[#2F3185] dark:text-indigo-400"></i>
          <span>TA: <?= esc(session()->get('year_code') ?? 'Pilih') ?></span>
        </button>
      ...
      >
        ...
        >
          <div>
            ...
            >
              <?= esc(session()->get('user_email') ?? session()->get('username') ?? '') ?>
            </span>
          </div>
          ...
          >
            ...
            <li>
              <button
                ...
                data-modal-url="<?= base_url('auth/change-password-form') ?>"
                data-modal-title="Change Password"
                data-modal-size="sm"
