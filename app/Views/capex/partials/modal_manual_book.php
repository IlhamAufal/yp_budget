<div x-show="manualBookOpen" 
     class="fixed inset-0 z-[9999] flex items-center justify-center p-4" 
     style="background-color: rgba(0,0,0,0.65); backdrop-filter: blur(4px);"
     x-cloak>
    <div class="w-full max-w-2xl bg-white dark:bg-boxdark rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-800"
         @click.self="manualBookOpen = false">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-gray-900">
            ...
            <button @click="manualBookOpen = false" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 flex justify-end">
            <button @click="manualBookOpen = false" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold rounded-lg text-xs transition">
                Tutup
            </button>
        </div>
    </div>
