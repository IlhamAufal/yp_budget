<div class="space-y-4">
    <div class="rounded-2xl border border-gray-200/80 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="w-full max-w-sm flex items-center gap-3">
            ...
            <select x-model="filterShowAll" @change="fetchData()" class="w-full rounded-xl border border-gray-200 bg-gray-50/50 dark:border-gray-700 dark:bg-gray-800 dark:text-white px-3.5 py-2 text-xs font-medium focus:border-brand-500 focus:bg-white outline-none transition">
        ...
        <button @click="exportExcel('View Capex All')" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 text-xs font-bold transition shadow-xs">
    ...
    <div class="rounded-2xl border border-gray-200/80 bg-white shadow-xs dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
        <div class="overflow-x-auto" style="max-height: 70vh;">
            <table class="w-full text-left text-xs border-collapse text-gray-600 dark:text-gray-300 min-w-[1300px]">
                <thead class="sticky top-0 z-10 bg-brand-500 text-white text-xs font-semibold">
                    <tr class="border-b border-brand-600 bg-brand-500 text-white font-semibold text-xs">
                        ...
                        <th class="border-r border-white/20 py-3 px-2 text-right text-white">Qty</th>
                        <th class="border-r border-white/20 py-3 px-3 text-right text-white">Unit Price (Mio)</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800 text-xs">
                    ...
                    <template x-for="(row, idx) in viewAllData" :key="idx">
                        <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-800/40 transition-colors">
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-4 font-medium text-gray-800 dark:text-gray-200" x-text="row.description"></td>
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-3 font-mono font-semibold text-brand-600 dark:text-brand-400" x-text="row.account"></td>
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-3 text-gray-700 dark:text-gray-300" x-text="row.cost_center"></td>
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-2 text-right font-mono" x-text="row.qty"></td>
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-3 text-right font-mono font-semibold" x-text="fmt(row.unit_price)"></td>
                            <td class="border-r border-gray-100 dark:border-gray-800 py-2.5 px-3 text-gray-600 dark:text-gray-400" x-text="row.remarks || '-'"></td>
                ...
                <tfoot x-show="viewAllData.length > 0" class="bg-gray-100 dark:bg-gray-800 font-bold text-gray-900 dark:text-white border-t-2 border-gray-300 dark:border-gray-700 text-xs">
                    <tr>
                        <td colspan="6" class="py-3 px-4 uppercase border-r border-gray-300 dark:border-gray-700">Total</td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.jan)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.feb)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.mar)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.apr)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.may)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.jun)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.jul)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.aug)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.sep)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.oct)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.nov)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(viewAllTotals.dec)"></td>
                        <td class="py-3 px-4 text-right font-mono text-brand-600 dark:text-brand-400 font-bold" x-text="fmt(viewAllTotals.total)"></td>
                    </tr>
                </tfoot>
            </table>
        </div>
