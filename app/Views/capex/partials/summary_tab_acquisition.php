<div class="space-y-6">
    <div class="rounded-2xl border border-gray-200/80 bg-white p-6 dark:border-gray-800 dark:bg-gray-900 shadow-xs flex flex-col lg:flex-row lg:items-end justify-between gap-5">
        <div class="w-full max-w-lg">
            ...
            <select x-model="filterShowAcq" @change="fetchData()" class="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white px-3.5 py-2.5 text-xs font-medium focus:bg-white dark:focus:bg-gray-900 focus:border-[#2F3185] focus:ring-2 focus:ring-[#2F3185]/20 outline-none transition">
        ...
        <div class="shrink-0">
            <button @click="exportExcel('Summary Acquisition')" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold rounded-xl shadow-xs transition-all inline-flex items-center gap-2 active:scale-[0.98]">
    ...
    <div>
        <h3 class="text-base font-bold text-gray-900 dark:text-white tracking-tight">Summary Berdasarkan Jenis Asset (Acquisition)</h3>
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Akumulasi nilai perolehan (akuisisi) aset tetap per kategori.</p>
    </div>
            ...
            <table class="w-full text-left text-xs border-collapse min-w-[1100px] whitespace-nowrap">
                <thead class="sticky top-0 z-10 bg-[#2F3185] text-white font-semibold border-b border-white/20 text-xs">
                    <tr class="bg-[#2F3185] text-white font-semibold">
                        <th class="border-r border-white/20 py-3.5 px-4 min-w-[240px] text-white font-semibold">Jenis Asset (Acquisition)</th>
                ...
                <tfoot x-show="acqData.length > 0" class="bg-[#2F3185]/10 dark:bg-[#2F3185]/20 font-bold text-gray-900 dark:text-white border-t-2 border-[#2F3185]/30 text-xs font-mono">
                    <tr>
                        <td class="py-3 px-4 font-sans border-r border-gray-300 dark:border-gray-700">Total Acquisition</td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.jan)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.feb)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.mar)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.apr)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.may)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.jun)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.jul)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.aug)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.sep)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.oct)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.nov)"></td>
                        <td class="py-3 px-2.5 text-right border-r border-gray-300 dark:border-gray-700" x-text="fmt(acqTotals.dec)"></td>
                        <td class="py-3 px-4 text-right text-[#2F3185] dark:text-indigo-400" x-text="fmt(acqTotals.total)"></td>
                    </tr>
                </tfoot>
            </table>
        </div>
