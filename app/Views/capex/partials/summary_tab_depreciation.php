<div class="space-y-4">
    <div class="rounded-2xl border border-gray-200/80 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="w-full max-w-sm flex items-center gap-3">
            ...
            <select x-model="filterShowDep" @change="fetchData()" class="w-full rounded-xl border border-gray-200 bg-gray-50/50 dark:border-gray-700 dark:bg-gray-800 dark:text-white px-3.5 py-2 text-xs font-medium focus:border-brand-500 focus:bg-white outline-none transition">
        ...
        <button @click="exportExcel('Summary Depreciation')" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 text-xs font-bold transition shadow-xs">
            ...
            <table class="w-full text-left text-xs border-collapse text-gray-600 dark:text-gray-300 min-w-[1000px]">
                <thead class="sticky top-0 z-10 bg-brand-500 text-white text-xs font-semibold">
                    <tr class="border-b border-brand-600 bg-brand-500 text-white font-semibold text-xs">
                        <th class="border-r border-white/20 py-3 px-4 min-w-[220px] text-white">Jenis Asset (Depreciation)</th>
                ...
                <tfoot x-show="depData.length > 0" class="bg-gray-100 dark:bg-gray-800 font-bold text-gray-900 dark:text-white border-t-2 border-gray-300 dark:border-gray-700 text-xs">
                    <tr>
                        <td class="py-3 px-4 uppercase border-r border-gray-300 dark:border-gray-700">Total Depreciation</td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.jan)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.feb)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.mar)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.apr)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.may)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.jun)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.jul)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.aug)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.sep)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.oct)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.nov)"></td>
                        <td class="py-3 px-2 text-right font-mono border-r border-gray-300 dark:border-gray-700" x-text="fmt(depTotals.dec)"></td>
                        <td class="py-3 px-4 text-right font-mono text-brand-600 dark:text-brand-400 font-bold" x-text="fmt(depTotals.total)"></td>
                    </tr>
                </tfoot>
            </table>
        </div>
