<div class="mb-6 bg-white dark:bg-boxdark p-4 rounded-xl shadow-xs border border-gray-100 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div class="w-full max-w-xs flex items-center gap-3">
        ...
        <select x-model="filterShowDep" @change="fetchData()" class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none">
    ...
    <button @click="exportExcel('Summary Depreciation')" class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 text-white px-4 py-2 text-xs font-medium hover:bg-emerald-700 transition shadow-xs">
        ...
        <table class="w-full text-left text-xs border-collapse">
            <thead>
                <tr class="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 font-semibold border-b border-gray-200 dark:border-gray-800">
                    <th class="p-3">JENIS ASSET (DEPRECIATION)</th>
            ...
            <tfoot>
                <tr class="bg-gray-50 dark:bg-gray-900/50 font-bold border-t-2 border-gray-300 dark:border-gray-700">
                    ...
                    <td class="p-3 text-right" x-text="fmt(depTotals.jan)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.feb)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.mar)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.apr)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.may)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.jun)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.jul)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.aug)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.sep)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.oct)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.nov)"></td>
                    <td class="p-3 text-right" x-text="fmt(depTotals.dec)"></td>
                    <td class="p-3 text-right text-primary" x-text="fmt(depTotals.total)"></td>
                </tr>
            </tfoot>
        </table>
    </div>
