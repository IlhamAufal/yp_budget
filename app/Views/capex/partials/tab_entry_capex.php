...
<div class="mb-6">
    <button type="button" @click="window.openManualBook && window.openManualBook()" class="w-full flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-red-600 hover:bg-red-100 transition font-semibold text-sm">
