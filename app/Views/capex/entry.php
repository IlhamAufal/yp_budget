    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
        <div class="p-5 border-b border-gray-100 flex justify-between items-center">
            ...
            <div class="relative min-w-[240px]">
                ...
                <input type="text" x-model="searchQuery" placeholder="Cari deskripsi / aset..." class="w-full pl-11 pr-4 py-2 bg-gray-50/60 border border-gray-200 rounded-xl text-xs focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
            </div>
        </div>
