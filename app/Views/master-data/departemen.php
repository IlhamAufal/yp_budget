...
<div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6 space-y-6" x-data="departmentPage()">
  ...
  <div class="rounded-2xl border border-gray-200/80 bg-white shadow-xs dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
    ...
    <div class="p-3.5 border-b border-gray-100 dark:border-gray-800">
      <form method="GET" action="<?= base_url('master/department') ?>" class="flex flex-wrap items-center gap-2.5">
        ...
        <select
          name="status"
          class="rounded-xl border border-gray-200 bg-gray-50/50 py-2 px-3 text-xs text-gray-800 focus:border-brand-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-brand-400 transition-colors min-w-[130px]"
        >
      ...
      <table class="w-full text-left border-collapse text-xs text-gray-600 dark:text-gray-300">
        <thead class="bg-brand-500 text-white text-xs font-semibold border-b border-brand-600">
          <tr>
            ...
            <th class="py-3 px-4 w-40 text-white">Code</th>
            <th class="py-3 px-4 text-white">Department</th>
