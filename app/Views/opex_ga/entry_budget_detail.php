    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <div class="flex items-center gap-2 text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">
                ...
                <a href="<?= base_url('opex-ga/entry-budget') ?>" class="hover:text-brand-500 transition-colors">Entry Budget</a>
                <i class="fa-solid fa-chevron-right text-[10px] text-gray-400"></i>
        ...
        <a href="<?= base_url('opex-ga/entry-budget') ?>" class="inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3.5 py-2 text-xs font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 shadow-xs transition-all">
            ...
            <table class="w-full text-left text-xs text-gray-600 dark:text-gray-300 border-collapse">
                <thead class="bg-brand-500 text-white text-xs font-semibold">
                    <tr class="border-b border-brand-600 bg-brand-500 text-white font-semibold">
                        ...
                        <th rowspan="2" class="border-r border-white/20 px-4 py-3 font-semibold text-white min-w-[240px]">General Administrative Expense</th>
