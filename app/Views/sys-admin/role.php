      ...
      <table class="w-full text-left border-collapse">
        <thead class="bg-brand-500 text-white font-semibold text-xs border-b border-brand-600">
          <tr class="bg-brand-500 text-white font-semibold">
            ...
            <th class="py-3 px-5 text-white">Nama Role</th>
            <th class="py-3 px-5 text-center text-white">Jumlah User</th>
                ...
                <td class="py-4 px-5">
                  <div class="flex items-center justify-end gap-2">
                    <button
                      ...
                      class="h-8 w-8 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 dark:hover:bg-indigo-500/10 transition-colors flex items-center justify-center shadow-2xs"
