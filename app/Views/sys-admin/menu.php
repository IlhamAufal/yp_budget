...
<div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6 space-y-6" x-data="menuPage()">
  ...
  <div class="space-y-4">
    <div>
      <h3 class="text-base font-bold text-gray-900 dark:text-white tracking-tight">Daftar Struktur Menu (Menu List)</h3>
      <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Struktur hirarki navigasi dan tautan modul sistem.</p>
    </div>
