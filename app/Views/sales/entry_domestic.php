...
<div x-data="{
    ...
    <div class="relative max-w-xs">
        ...
        <input type="text" x-model="search" placeholder="Search customer or product..." 
               class="w-full rounded-lg border border-gray-300 bg-gray-50/60 py-2 pl-10 pr-4 text-xs md:text-sm shadow-xs focus:border-primary focus:bg-white focus:ring-1 focus:ring-primary">
    </div>
