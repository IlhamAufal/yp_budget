    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-base font-bold text-gray-900 dark:text-white">Upload Data Export</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Unggah file Excel hasil pengisian template Sales Export.</p>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Agregasi ulang data transaksi ke Summary Export.</p>
                </div>
            </div>
            <div class="p-4 rounded-xl bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-900/50 text-xs text-amber-900 dark:text-amber-200">
                ...
                <p class="text-gray-600 dark:text-gray-300 mt-1">Proses ini akan mengonsolidasikan seluruh data detail negara ke ringkasan ekspor.</p>
            </div>
            <button type="button" @click="processSummarySKU()" class="w-full py-3 bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold rounded-xl flex items-center justify-center gap-2">
                <i class="fa-solid fa-gears"></i> Jalankan Process Summary SKU Export
            </button>
        </div>
    </div>
</div>
