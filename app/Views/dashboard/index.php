...
<div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6 space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs">
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-2 bg-gray-50 dark:bg-gray-800 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Tahun Anggaran:</span>
                <span class="text-xs font-bold text-[#2F3185] dark:text-indigo-400"><?= (int) ($workingYear ?? date('Y')) ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-gray-500 dark:text-gray-400">Total OPEX GA & Selling</span>
                <h3 class="text-lg md:text-xl font-bold font-mono text-gray-900 dark:text-white mt-1">
                    Rp <?= number_format($stats['opex'] ?? 0, 0, ',', '.') ?>
                </h3>
                <span class="text-xs font-medium text-emerald-600 dark:text-emerald-400 inline-flex items-center gap-1 mt-1">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                    <?= number_format($stats['budget_entries'] ?? 0) ?> baris entry budget
                </span>
            </div>
            <div class="w-11 h-11 rounded-xl bg-[#2F3185]/10 text-[#2F3185] dark:bg-[#2F3185]/20 dark:text-indigo-400 flex items-center justify-center shrink-0">
        ...
        <div class="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-gray-500 dark:text-gray-400">Total CAPEX Proposed</span>
                <h3 class="text-lg md:text-xl font-bold font-mono text-gray-900 dark:text-white mt-1">
                    Rp <?= number_format($stats['capex'] ?? 0, 0, ',', '.') ?>
                </h3>
                <span class="text-xs font-medium text-amber-600 dark:text-amber-400 inline-flex items-center gap-1 mt-1">
        ...
        <div class="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-gray-500 dark:text-gray-400">Target Sales Consolidated</span>
                <h3 class="text-lg md:text-xl font-bold font-mono text-gray-900 dark:text-white mt-1">
        ...
        <div class="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-gray-500 dark:text-gray-400">Plan Headcount (MPP)</span>
                <h3 class="text-lg md:text-xl font-bold font-mono text-gray-900 dark:text-white mt-1">
                    <?= number_format($stats['mpp'] ?? 0) ?> Org
                </h3>
                <span class="text-xs font-medium text-purple-600 dark:text-purple-400 inline-flex items-center gap-1 mt-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs overflow-hidden">
            <div class="p-5 border-b border-gray-100 dark:border-gray-800">
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Tren Budget Bulanan</h3>
            ...
            <?php if (empty($hasBudget)): ?>
                <div class="p-10 text-center">
                    <div class="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-100 dark:bg-gray-800 text-gray-400 mb-2">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs overflow-hidden">
            <div class="p-5 border-b border-gray-100 dark:border-gray-800">
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Komposisi Anggaran per Modul</h3>
    ...
    <div class="space-y-3">
        <div>
            <h3 class="text-base font-bold text-gray-900 dark:text-white">Pintasan Fitur Utama</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Navigasi cepat ke modul penganggaran dan master data.</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <a href="<?= base_url('opex-ga/entry-budget') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">OPEX GA</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Entry Beban Umum & Admin</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>

            <a href="<?= base_url('opex-selling/entry-budget') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">OPEX Selling</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Entry Biaya Penjualan</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>

            <a href="<?= base_url('capex/entry') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">CAPEX Entry</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Pengajuan Aset Modal</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>

            <a href="<?= base_url('mpp/entry') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">New MPP</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Manpower Planning</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>

            <a href="<?= base_url('sales') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">Sales Plan</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Target Domestik & Ekspor</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>

            <a href="<?= base_url('pl') ?>" class="p-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs hover:border-[#2F3185] hover:shadow-md transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <span class="text-xs font-bold text-gray-900 dark:text-white group-hover:text-[#2F3185] dark:group-hover:text-indigo-400 block transition-colors">P/L Report</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Laporan Laba Rugi</span>
                    </div>
                </div>
                <i class="fa-solid fa-chevron-right text-xs text-gray-300 dark:text-gray-600 group-hover:text-[#2F3185] group-hover:translate-x-0.5 transition-all"></i>
            </a>
    ...
    <div class="space-y-3">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Status Progress Input Per Cost Center</h3>
            ...
            <a href="<?= base_url('monitoring') ?>" class="text-xs font-semibold text-[#2F3185] dark:text-indigo-400 hover:underline">
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-[#2F3185] text-white font-semibold text-xs border-b border-white/20">
                        <tr class="bg-[#2F3185] text-white font-semibold text-xs">
                            <th class="px-5 py-3 text-white font-semibold">Cost Center</th>
                            <th class="px-5 py-3 text-white font-semibold">Department</th>
                            <th class="px-5 py-3 text-right text-white font-semibold">OPEX GA</th>
                            <th class="px-5 py-3 text-right text-white font-semibold">CAPEX</th>
                            <th class="px-5 py-3 text-center text-white font-semibold">MPP</th>
                            <th class="px-5 py-3 text-white font-semibold">Status</th>
                            <th class="px-5 py-3 text-right text-white font-semibold">Aksi</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td colspan="7" class="py-12 text-center text-gray-400 dark:text-gray-500">
                                    <div class="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p class="font-semibold text-gray-800 dark:text-gray-200">Belum ada data entry untuk tahun ini</p>
                        ...
                        <?php else: ?>
                            <?php foreach ($statusRows as $row): ?>
                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors">
                                    <td class="px-5 py-3.5 font-mono font-bold text-[#2F3185] dark:text-indigo-400"><?= esc($row['cc_sap'] ?? $row['cost_center']) ?></td>
                                    ...
                                    <td class="px-5 py-3 text-center font-mono font-semibold text-gray-800 dark:text-gray-200">
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <a href="<?= base_url('monitoring') ?>" class="text-[#2F3185] hover:text-[#25276d] dark:text-indigo-400 dark:hover:text-indigo-300 font-semibold">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
